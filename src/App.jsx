...
const CAR_BRANDS = {
  "Toyota 豐田":["Vios","Yaris Cross","Corolla Altis","Corolla Cross","Corolla","Camry","RAV4","bZ4X","bZ3","Sienna","Alphard","Vellfire","Hilux","Town Ace","Prius","Crown","GR86","GR Yaris","GR Supra","Prado"],
  "Honda 本田":["FIT","HR-V","CR-V","CR-V e:HEV","ZR-V","Accord","Odyssey","Civic","e:N1","e:NP1"],
  "Nissan 日產":["Kicks","Sentra","X-Trail","X-Trail e-Power","Leaf","GT-R","Navara","Livina","March"],
  "Ford 福特":["Territory","Kuga","Ranger","Mustang","Bronco","Explorer","Maverick"],
  "Mitsubishi 三菱":["Colt Plus","Eclipse Cross","Outlander","Delica","ASX","Galant Fortis"],
  "Mazda 馬自達":["Mazda2","Mazda3","Mazda3 Fastback","MX-5","Mazda6","CX-3","CX-30","CX-5","CX-60","CX-90","MX-30"],
  "Hyundai 現代":["Elantra","Tucson","Tucson Hybrid","Santa Fe","Kona","Kona Hybrid","Custin","Ioniq5","Ioniq6","Ioniq9","Staria"],
  "Kia 起亞":["Picanto","Stonic","Ceed","Seltos","Sportage","Sorento","Carnival","EV6","EV9"],
  "Subaru 速霸陸":["Impreza","Levorg","BRZ","XV","Crosstrek","Forester","Outback","Legacy","WRX","Solterra"],
  "Suzuki 鈴木":["Swift","Swift Sport","Ignis","Baleno","Jimny","Vitara","SX4 S-Cross","Across"],
  "Benz 賓士":["A-Class","B-Class","C-Class","E-Class","S-Class","CLA","CLE","GLA","GLB","GLC","GLE","GLS","AMG GT","EQA","EQB","EQC","EQE","EQE SUV","EQS","EQS SUV","EQT","G-Class","V-Class","Citan"],
  "BMW 寶馬":["1系","2系","3系","4系","5系","6系","7系","8系","X1","X2","X3","X4","X5","X6","X7","iX1","iX2","iX3","i4","i5","i7","iX","M2","M3","M4","M5","M8","XM","Z4"],
  "Audi 奧迪":["A1","A3","A4","A5","A6","A7","A8","TT","TTS","R8","Q2","Q3","Q4 e-tron","Q5","Q6 e-tron","Q7","Q8","e-tron GT","RS3","RS4","RS5","RS6","RS7"],
  "Volkswagen 福斯":["Polo","Golf","Golf GTI","Golf R","Tiguan","Touareg","Arteon","Passat","T-Roc","T-Cross","ID.3","ID.4","ID.5","ID.7","Caravelle","Multivan"],
  "Volvo 富豪":["S60","S90","V60","V90","XC40","XC60","XC90","C40","EX30","EX40","EX90","EC40"],
  "Lexus 凌志":["IS","ES","LS","RC","LC","GS","UX","NX","RX","GX","LX","RZ","LBX"],
  "Infiniti 無限":["Q50","Q60","QX50","QX55","QX60","QX80"],
  "Porsche 保時捷":["718 Boxster","718 Cayman","911","Panamera","Macan","Macan EV","Cayenne","Taycan"],
  "Land Rover 路虎":["Defender","Discovery","Discovery Sport","Range Rover","Range Rover Sport","Range Rover Velar","Range Rover Evoque","Freelander"],
  "Jaguar 捷豹":["XE","XF","XJ","F-Type","E-Pace","F-Pace","I-Pace"],
  "Mini 迷你":["Mini 3門","Mini 5門","Mini Convertible","Mini Clubman","Mini Countryman","Mini Paceman","Mini Cooper E","Mini Countryman E"],
  "Tesla 特斯拉":["Model 3","Model 3 Highland","Model S","Model X","Model Y","Model Y Juniper","Cybertruck"],
  "MG 名爵":["MG4","MG5","ZS","ZS EV","HS","HS PHEV","G50 Plus","MG3 Hybrid+","Cyberster"],
  "Skoda 斯柯達":["Fabia","Octavia","Octavia Combi","Superb","Karoq","Kodiaq","Enyaq","Enyaq Coupe"],
  "Peugeot 寶獅":["208","308","408","508","2008","3008","4008","5008","e-208","e-2008","e-308","Traveller"],
  "Citroen 雪鐵龍":["C3","C4","C5 X","C5 Aircross","Berlingo","SpaceTourer","e-C3","e-C4"],
  "Alfa Romeo 愛快羅密歐":["Giulia","Stelvio","Junior","Tonale","GTV"],
  "Maserati 瑪莎拉蒂":["Ghibli","Quattroporte","Levante","GranTurismo","Grecale"],
  "Ferrari 法拉利":["296 GTB","296 GTS","Roma","SF90 Stradale","F8 Tributo","812 Competizione","Purosangue","12Cilindri"],
  "Lamborghini 藍寶堅尼":["Huracán","Urus","Urus SE","Revuelto"],
  "Bentley 賓利":["Continental GT","Continental GTC","Flying Spur","Bentayga"],
  "Rolls-Royce 勞斯萊斯":["Ghost","Wraith","Dawn","Cullinan","Spectre"],
  "Aston Martin 奧斯頓馬丁":["Vantage","DB11","DB12","DBS","DBX"],
  "McLaren 麥拉倫":["Artura","720S","750S","GT"],
  "Lotus 蓮花":["Emira","Eletre","Emeya"],
  "Genesis 捷尼賽思":["G70","G80","G90","GV70","GV80","GV60"],
  "Foxtron 鴻華先進":["Model C","Bria"],
  "Luxgen 納智捷":["N7","URX","U7"],
