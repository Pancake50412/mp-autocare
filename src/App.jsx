...
const CAR_BRANDS = {
  "Alfa Romeo 愛快":["Giulia","Giulietta","GT","GTV","Junior","MiTo","Stelvio","Tonale"],
  "Aston Martin 奧斯頓馬丁":["DB11","DB12","DB9","DBS","DBX","Rapide","V12 Vantage","V8 Vantage","Vantage","Virage"],
  "Audi 奧迪":["A1","A3","A4","A4 Allroad","A5","A6","A6 Allroad","A7","A8","e-tron","e-tron GT","e-tron Sportback","Q2","Q3","Q3 Sportback","Q4 e-tron","Q5","Q5 Sportback","Q6 e-tron","Q7","Q8","Q8 e-tron","R8","RS3","RS4","RS5","RS6","RS7","RS Q3","RS Q8","S3","S4","S5","S6","S7","S8","SQ5","SQ7","SQ8","TT","TTS","TT RS"],
  "Bentley 賓利":["Bentayga","Continental GT","Continental GTC","Continental Flying Spur","Flying Spur","Mulsanne"],
  "BMW 寶馬":["1系","2系","3系","3系 GT","4系","5系","6系","6系 GT","7系","8系","i3","i4","i5","i7","i8","iX","iX1","iX2","iX3","M2","M3","M4","M5","M6","M8","X1","X2","X3","X3 M","X4","X4 M","X5","X5 M","X6","X6 M","X7","XM","Z4"],
  "Chery 奇瑞":["Tiggo 4 Pro","Tiggo 7 Pro","Tiggo 8 Pro"],
  "Citroen 雪鐵龍":["Berlingo","C3","C3 Aircross","C4","C4 Cactus","C5","C5 Aircross","C5 X","C6","DS3","DS4","DS5","e-C3","e-C4","SpaceTourer"],
  "Ferrari 法拉利":["12Cilindri","296 GTB","296 GTS","458 Italia","458 Speciale","458 Spider","488 GTB","488 Pista","488 Spider","599 GTB","612 Scaglietti","812 Competizione","812 GTS","812 Superfast","California","California T","F12berlinetta","F8 Spider","F8 Tributo","FF","GTC4Lusso","Portofino","Purosangue","Roma","SF90 Stradale","SF90 Spider"],
  "Ford 福特":["Bronco","EcoSport","Edge","Escape","Explorer","Everest","Focus","Kuga","Maverick","Mondeo","Mustang","Mustang Mach-E","Ranger","Territory"],
  "Foxtron 鴻華先進":["Bria","Model C"],
  "Genesis 捷尼賽思":["G70","G80","G90","GV60","GV70","GV80"],
  "Honda 本田":["Accord","City","Civic","CR-V","CR-V e:HEV","CR-Z","e:N1","Fit","Freed","HR-V","Insight","Jade","Jazz","Legend","Life","Odyssey","Stream","StepWGN","ZR-V"],
  "Hyundai 現代":["Custin","Elantra","Genesis","Grand Starex","H-1","i10","i20","i30","i40","Ioniq","Ioniq 5","Ioniq 6","Ioniq 9","ix35","Kona","Kona Hybrid","Nexo","Santa Fe","Sonata","Staria","Terracan","Tucson","Tucson Hybrid","Veloster"],
  "Infiniti 無限":["EX","FX","G25","G35","G37","JX","M","Q30","Q50","Q60","Q70","QX30","QX50","QX55","QX60","QX70","QX80"],
  "Jaguar 捷豹":["E-Pace","F-Pace","F-Type","I-Pace","S-Type","X-Type","XE","XF","XJ"],
  "Kia 起亞":["Carnival","Carens","Ceed","EV6","EV9","Morning","Niro","Opirus","Optima","Picanto","ProCeed","Rio","Seltos","Soul","Sportage","Stinger","Stonic","Sorento"],
  "Lamborghini 藍寶堅尼":["Aventador","Gallardo","Huracán","Reventón","Urus","Urus SE","Revuelto"],
  "Land Rover 路虎":["Defender","Discovery","Discovery Sport","Freelander","Range Rover","Range Rover Evoque","Range Rover Sport","Range Rover Velar"],
  "Lexus 凌志":["CT","ES","GS","GX","IS","IS C","IS F","LBX","LC","LS","LX","NX","RC","RC F","RX","RZ","UX"],
  "Lotus 蓮花":["Eletre","Emeya","Emira","Evija","Evora","Exige"],
  "Luxgen 納智捷":["MPV","N7","S3","S5","SUV","U5","U6","U7","URX"],
  "Maserati 瑪莎拉蒂":["Ghibli","GranCabrio","GranTurismo","Grecale","Levante","MC20","Quattroporte"],
  "Mazda 馬自達":["2","3","3 Fastback","5","6","6 Wagon","CX-3","CX-30","CX-5","CX-60","CX-7","CX-9","CX-90","Mazda2","Mazda3","Mazda5","Mazda6","MX-5","MX-30","RX-8"],
  "McLaren 麥拉倫":["570S","600LT","620R","650S","675LT","720S","750S","Artura","GT","MP4-12C","P1"],
  "Mercedes-Benz 賓士":["A-Class","AMG GT","B-Class","C-Class","CLA","CLE","CLS","E-Class","EQA","EQB","EQC","EQE","EQE SUV","EQS","EQS SUV","G-Class","GLA","GLB","GLC","GLE","GLS","S-Class","SL","SLC","SLK","V-Class"],
  "MG 名爵":["Cyberster","G50 Plus","HS","HS PHEV","MG3 Hybrid+","MG4","MG5","MG7","ZS","ZS EV"],
  "Mini 迷你":["Clubman","Convertible","Cooper","Cooper E","Countryman","Countryman E","Coupe","John Cooper Works","Paceman","Roadster"],
  "Mitsubishi 三菱":["ASX","Colt Plus","Delica","Eclipse Cross","Galant Fortis","Grandis","Outlander","Pajero","Zinger"],
  "Nissan 日產":["370Z","Almera","Bluebird","GT-R","Juke","Kicks","Leaf","Livina","March","Murano","Navara","Note","Pathfinder","Quest","Sentra","Serena","Tiida","X-Trail","X-Trail e-Power"],
  "Peugeot 寶獅":["1008","107","107 CC","2008","207","207 CC","207 SW","208","3008","301","307","307 CC","307 SW","308","408","508","508 SW","4008","5008","e-208","e-2008","e-308","RCZ","Traveller"],
  "Porsche 保時捷":["718 Boxster","718 Cayman","911","918 Spyder","Boxster","Cayenne","Cayenne Coupe","Cayman","Macan","Macan EV","Panamera","Taycan","Taycan Cross Turismo"],
  "Rolls-Royce 勞斯萊斯":["Cullinan","Dawn","Ghost","Phantom","Silver Ghost","Spectre","Wraith"],
  "Skoda 斯柯達":["Enyaq","Enyaq Coupe","Fabia","Karoq","Kodiaq","Octavia","Octavia Combi","Rapid","Roomster","Scala","Superb","Yeti"],
  "Subaru 速霸陸":["BRZ","Crosstrek","Exiga","Forester","Impreza","Justy","Legacy","Levorg","Outback","Solterra","Trezia","WRX","XV"],
  "Suzuki 鈴木":["Across","Alto","Baleno","Grand Vitara","Ignis","Jimny","Kizashi","S-Cross","Swift","Swift Sport","SX4","Vitara"],
  "Tesla 特斯拉":["Cybertruck","Model 3","Model 3 Highland","Model S","Model X","Model Y","Model Y Juniper"],
  "Toyota 豐田":["Alphard","Auris","Avensis","Aygo","bZ3","bZ4X","Camry","Corolla","Corolla Altis","Corolla Cross","Crown","GR86","GR Supra","GR Yaris","Hilux","Hiace","Innova","Land Cruiser","Prado","Prius","Prius+","RAV4","Rush","Sienna","Town Ace","Vellfire","Vios","Wish","Yaris","Yaris Cross"],
  "Volkswagen 福斯":["Arteon","Beetle","Caddy","Caravelle","CC","EOS","Golf","Golf GTI","Golf R","Golf Variant","ID.3","ID.4","ID.5","ID.7","Jetta","Multivan","Phaeton","Polo","Scirocco","Sharan","T-Cross","T-Roc","Tiguan","Tiguan Allspace","Touareg","Touran"],
  "Volvo 富豪":["C30","C40","C70","EC40","EX30","EX40","EX90","S40","S60","S80","S90","V40","V60","V70","V90","V90 Cross Country","XC40","XC60","XC70","XC90"],
  "其他":["其他車型"],
};
...
const serviceCategories = [
  ...
  { label:"💎 鍍膜", items:["全車鍍膜","客製鍍膜","半年期鍍膜","塑料鍍膜","輪框鍍膜","大燈鍍膜"] },
  { label:"➕ 其他加購", items:["臭氧除臭","前玻璃鍍膜","前後玻璃鍍膜","全車玻璃鍍膜","局部內裝清洗","刮傷處理","引擎室清洗","頂棚清洗","空氣清淨噴霧"] },
  { label:"❗️ 特殊處理", items:["螞蟻","嘔吐","積水"] },
];
...
function CustomSelect({S,value,onChange,options,placeholder}){
  const [open,setOpen]=useState(false);
  ...
  const lbl=sel?(sel.label||sel):(placeholder||"請選擇");
  return (
    <div ref={ref} style={{position:"relative"}}>
      <button type="button"
        style={{...S.selectInput,textAlign:"left",display:"flex",alignItems:"center",justifyContent:"space-between",cursor:"pointer"}}
        onClick={()=>setOpen(o=>!o)}>
        <span style={{color:value?S.input.color:"rgba(150,150,150,0.8)"}}>{lbl}</span>
        <span style={{fontSize:12,color:S.sub}}>{open?"▲":"▼"}</span>
      </button>
      {open&&(
        <div style={{position:"absolute",zIndex:999,top:"calc(100% + 4px)",left:0,right:0,background:S.modal.background,border:S.card.border,borderRadius:10,maxHeight:220,overflowY:"auto",boxShadow:"0 8px 24px rgba(0,0,0,0.3)"}}>
          {options.map((o,i)=>{
            const val=o.value||o; const lbl2=o.label||o;
            return <div key={i}
              style={{padding:"11px 14px",cursor:"pointer",color:val===value?"#3498db":S.input.color,background:val===value?"rgba(52,152,219,0.1)":"transparent",fontSize:15,borderBottom:i<options.length-1?`1px solid ${S.card.border}`:"none"}}
